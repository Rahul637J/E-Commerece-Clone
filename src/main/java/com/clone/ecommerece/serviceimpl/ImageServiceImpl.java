...
{
	public ImageServiceImpl(StoreRepo storeRepo, ImageRepo imageRepo, ResponseStructure<byte[]> responseStructure2,
	...
	public ResponseEntity<byte []> getStoreImage(String imageId) 
	{
		return imageRepo.findById(imageId).map(image->{
			...
			responseStructure2.setMsg("Image Found");
//			responseStructure2.setData(image.getImageBytes());
